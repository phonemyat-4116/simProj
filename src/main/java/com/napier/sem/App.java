...
public class App {
    ...
    public ArrayList<Employee> getSalariesByRole(String role)
    {
        ...
        try (PreparedStatement pstmt = con.prepareStatement(sql)) {
            ...
            System.out.println("Failed to get salary by role: " + e.getMessage());
        }
...
Because your main() method supports two modes automatically:

Scenario	Command	Database host	Port used	Works with
🧑‍💻 Local run	java -jar seMethods.jar	localhost	33060	Local / exposed DB port
🐳 Docker Compose	java -jar seMethods.jar db:3306 10000	db	3306	Internal Docker network
 */
